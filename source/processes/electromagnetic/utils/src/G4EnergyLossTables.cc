...
G4ThreadLocal G4EnergyLossTablesHelper *G4EnergyLossTables::t = nullptr;
G4ThreadLocal G4EnergyLossTablesHelper *G4EnergyLossTables::null_loss = nullptr;
G4ThreadLocal G4ParticleDefinition* G4EnergyLossTables::lastParticle = nullptr;
G4ThreadLocal G4double G4EnergyLossTables::QQPositron = 1.0; // e_squared
G4ThreadLocal G4double G4EnergyLossTables::Chargesquare = 0.0;
...
G4ThreadLocal G4EnergyLossTables::helper_map *G4EnergyLossTables::dict = nullptr;
